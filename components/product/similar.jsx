...
const Similar = ({ slug }) => {
  ...
  const similarBooks = useMemo(() => {
    ...
    // Filter out the current book by slug and return first 4
    ...
    return (
      <div className="flex flex-col gap-12 bg-[#EBF8F7] items-center py-24">
        ...
        <div className="container text-center">
          <p className="text-red-600">Unable to load similar books at the moment.</p>
        </div>
      </div>
    );
  }

  // Don't render the section if no similar books found
