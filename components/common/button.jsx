...
const Button = ({ size, text, style, color, iconLeft, iconRight, onClick }) => {
    const buttonStyles =
    ...
    return (
        <button onClick={onClick} className={`btn text-btn uppercase px-3 h-10 flex justify-center items-center gap-2 rounded-sm ${buttonStyles} ${buttonSize}`}>
