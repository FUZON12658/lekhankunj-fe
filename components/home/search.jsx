...
const Search = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="w-[20.5rem] mx-auto">
      <div
        className={`relative border rounded-lg flex justify-between items-center px-3 transition-all duration-200 ${
          isFocused
